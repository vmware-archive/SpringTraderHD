...
nano.conf.urls = {
    ...
    //analytics : nano.conf.urlRoot + 'account/' + nano.conf.accountIdUrlKey +'/analytics'
    analytics: nano.conf.urlRoot + 'analytics'
};
...
nano.conf.tpls = {
    ...
    busystock : nano.conf.tplRoot + 'busystock.tpl',
    busystockRow : nano.conf.tplRoot + 'busystockRow.tpl'
};
